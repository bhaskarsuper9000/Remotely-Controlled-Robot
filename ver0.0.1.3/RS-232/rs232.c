...
int OpenComport(int comport_number, int baudrate)
{
 ...
 // new_port_settings.c_cflag = baudr | CS8 | CLOCAL | CREAD;
  new_port_settings.c_cflag = baudr | CS8 | CSTOPB | CREAD;
  new_port_settings.c_iflag = IGNPAR;
  new_port_settings.c_oflag = 0;
  new_port_settings.c_lflag = 0;
  new_port_settings.c_cc[VMIN] = 0;      /* block untill n bytes are received  = 2*/
  new_port_settings.c_cc[VTIME] = 0;     /* block untill a timer expires (n * 100 mSec.)  = 50 */
